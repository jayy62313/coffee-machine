...
def is_resources_sufficient(order_ingredients):
    """Returned True when order can be made, False if ingredients are insufficient."""
...
def process_coins():
    """Returned the total calculated from coins inserted"""
    print("insert coins: ")
...
while is_on:
    ...
    if choice == "off":
        ...
        if is_resources_sufficient(drink["ingredients"]):
            ...
            is_Transcation_successful(payment,drink["cost"])
